...
\begin{figure}
	\centering
	\subfigure[V6 gegen V8 auf MPQ mit news Emeddings]{\includegraphics[width=0.49\textwidth]{img/CrossDomain_V6-V8_MPQ_newsEmb.png}}
	\subfigure[V6 gegen V8 auf MPQ mit tweets Emeddings]{\includegraphics[width=0.49\textwidth]{img/CrossDomain_V6-V8_MPQ_tweetsEmb.png}}
	\subfigure[V6 gegen V8 auf SemEval mit news Emeddings]{\includegraphics[width=0.49\textwidth]{img/CrossDomain_V6-V8_SemEval_newsEmb.png}}
	\subfigure[V6 gegen V8 auf SemEval mit tweets Emeddings]{\includegraphics[width=0.49\textwidth]{img/CrossDomain_V6-V8_SemEval_tweetsEmb.png}}
...
\begin{figure}
	\centering
	\subfigure[V6 gegen V10 auf MPQ mit news Emeddings]{\includegraphics[width=0.49\textwidth]{img/DistantPhase_V6-V10_MPQ_newsEmb.png}}
	\subfigure[V6 gegen V10 auf MPQ mit tweets Emeddings]{\includegraphics[width=0.49\textwidth]{img/DistantPhase_V6-V10_MPQ_tweetsEmb.png}}
	\subfigure[V6 gegen V10 auf SemEval mit news Emeddings]{\includegraphics[width=0.49\textwidth]{img/DistantPhase_V6-V10_SemEval_newsEmb.png}}
...
\begin{figure}
	\centering
	\subfigure[V8 gegen V12 auf MPQ mit news Emeddings]{\includegraphics[width=0.49\textwidth]{img/DistantPhase_V8-V12_MPQ_newsEmb.png}}
	\subfigure[V8 gegen V12 auf MPQ mit tweets Emeddings]{\includegraphics[width=0.49\textwidth]{img/DistantPhase_V8-V12_MPQ_tweetsEmb.png}}
	\subfigure[V8 gegen V12 auf SemEval mit news Emeddings]{\includegraphics[width=0.49\textwidth]{img/DistantPhase_V8-V12_SemEval_newsEmb.png}}
	\subfigure[V8 gegen V12 auf SemEval mit tweets Emeddings]{\includegraphics[width=0.49\textwidth]{img/DistantPhase_V8-V12_SemEval_tweetsEmb.png}}
...
\begin{figure}
	\centering
	\subfigure[V6 auf MPQ mit news Emeddings]{\includegraphics[width=0.49\textwidth]{img/Embeddings_V6_MPQ.png}}
	\subfigure[V6 auf SemEval mit tweets Emeddings]{\includegraphics[width=0.49\textwidth]{img/Embeddings_V6_SemEval.png}}
...
\begin{figure}
	\centering
	\subfigure[V8 auf MPQ mit news Emeddings]{\includegraphics[width=0.49\textwidth]{img/Embeddings_V8_MPQ.png}}
	\subfigure[V8 auf SemEval mit tweets Emeddings]{\includegraphics[width=0.49\textwidth]{img/Embeddings_V8_SemEval.png}}
...
\begin{figure}
	\centering
	\subfigure[V10 auf MPQ mit news Emeddings]{\includegraphics[width=0.49\textwidth]{img/Embeddings_V10_MPQ.png}}
...
\begin{figure}
	\centering
	\subfigure[V12 auf MPQ mit news Emeddings]{\includegraphics[width=0.49\textwidth]{img/Embeddings_V12_MPQ.png}}
	\subfigure[V12 auf SemEval mit tweets Emeddings]{\includegraphics[width=0.49\textwidth]{img/Embeddings_V12_SemEval.png}}
