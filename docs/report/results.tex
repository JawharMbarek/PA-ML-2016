...
\fixme{Resultate charts sind momentan auskommentiert (warten auf die aktuellsten resultate)}
\section{CrossDomain}
...
%\end{figure}
\fixme{Baseline erklärung/referenzierung?!}
...
\fixme{Referenz auf Länge der Sätze, im Kapitel Daten}
