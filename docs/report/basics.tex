...
In der \emph{Max-Pooling} Schicht wird ein grossteil der in der Feature-Map vorhandenen Informationen verworfen.
\subsection{Ausgabeschicht}
Innerhalb eines CNN wird die Kombination aus Convolutional und Max-Pooling Schicht mehrfach hintereinander gereiht.
